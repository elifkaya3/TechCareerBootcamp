...
/* ES6 Const & Let */
var nameVar = "Elif Kaya";
var nameVar = "Elif Kaya";
console.log(nameVar);

let nameLet = "Elif Kaya";
//let nameLet = "Melih KAPLAN";
console.log(nameLet);

const nameConst = "Elif Kaya";
//nameConst = "Kamil";
...
var userObj = getUser(1, "Elif", "Kaya");
...
var userObj2 = getUserES6("Elif", "Kaya");
...
/* ES6 */
class ES6Person {
    constructor(name = "Elif", year = new Date().getFullYear()) {
        this.name = name;
        this.year = year;
...
var es6p2 = new ES6Person("Elif Kaya", 1996);
console.log(es6p);
...
const ES6pStudent = new Student("Elif Kaya", 1991, "React");
