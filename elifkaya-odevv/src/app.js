            ...
            <div className="container pt-5">
                ...
                <div className="row p-3 border border-3 rounded-3 shadow-lg p-3 mb-5 bg-body rounded">
                    <div className="col-6 ">
                        ...
                        <button className="btn btn-primary me-2" onClick={this.brandChangeApple}>Apple
                        </button>

                        <button className="btn btn-light me-2" onClick={this.brandChangeXiaomi}>Xiaomi
                        </button>

                        <button className="btn btn-warning me-2" onClick={this.brandChangeHuawei}>Huawei
                        </button>

                        <button className="btn btn-dark" onClick={this.brandChangeSamsung}>Samsung
                        </button>
